...
RUN_ROOT=${RUN_ROOT:-/root/autodl-tmp/runs/uav_multispec3d_active17_registered100_umgs_i_$(date +%Y%m%d_%H%M%S)}
GPU_ID=${GPU_ID:-0}
...
SCENES=(
  banana_01_20260530_1616
  banana_02_20260530_1641
  maize_01_20260526_0959
  maize_02_20260526_1658
  maize_03_20260527_1103
  wogan_mandarin_03_20260528_1441
  wogan_mandarin_05_20260528_1621
)
BANDS=(G R RE NIR)
...
{
  "batch": "uav_multispec3d_active17_registered100_umgs_i",
  "purpose": "Full UMGS-I training/evaluation for active17 scenes with 100% RGB registration in the 20260602 COLMAP pass; excludes paused Road, low-registration Eucalyptus03, pruned Wogan01 pending rerun, and Wogan04 pending two-flight COLMAP rerun",
  "repo": "$REPO",
  "python": "$PY",
  "colmap": "$COLMAP",
  "minima": "$MINIMA",
